...
private:
    ...
    void process_00EN(unsigned short opcode);
    void process_8XYN(unsigned short opcode);
    void process_EXNN(unsigned short opcode);
    void process_FXNN(unsigned short opcode);
